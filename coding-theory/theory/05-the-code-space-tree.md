...
Therefore, no matter what decoding strategy is used, it is impossible to produce three distinct length-1 codewords. The problem is simply a **lack of available codewords**.
