# 1. An Introduction to the MDL Principle
...
```math
M^{*} = \mathop{\arg\min}_{M} \mathcal{L}_{\text{MDL}}(M)
```
...
## 1.1. Intuition and Model Complexity
...
## 1.2. Two Interpretations of "Description"
...
### 1.4.2. Coding the Data Given a Model
...
### 1.4.3. Extensions and Practical Considerations
...
#### 1.4.3.1. Universal and Distribution-Free Codes
...
#### 1.4.3.2. The Appearance of Probabilities
...
## 1.5. Relation to Other Concepts
